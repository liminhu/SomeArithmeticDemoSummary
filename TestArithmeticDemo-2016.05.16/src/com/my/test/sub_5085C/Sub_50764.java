...
public class Sub_50764 {
	
	public static int __ROR4__(int signed, int shift) {
	...
	public static int bytesToIn(char[] src, int offset) {
		return (int) ((src[offset] & 0xFF) | ((src[offset + 1] & 0xFF) << 8)
				| ((src[offset + 2] & 0xFF) << 16) | ((src[offset + 3] & 0xFF) << 24));
	}
	
    public static char[] intDataPutIntoByteArray(char[] src, int value,
			int offset) {
		char[] a = new char[4];
	...
	public static int sub_50764(char[] a1, int a2, char[] a3){
		char[] v3; 
		int v4; 
		int v5; 
		int v6; 
		...
		v7 = v6 + v4;
		v8 = v6 + v4 >= v6;
		intDataPutIntoByteArray(v3, v6 + v4, 20);
		if (v6 + v4 < v6)
			v7 = bytesToIn(a3, 24);
		v9 = v4 >> 3;
		if (!v8) {
			intDataPutIntoByteArray(v3, v7 + 1, 24);
		}
		v10 = v9 & 0x3F;
		v11 = 64 - v10;
		int t = bytesToIn(a3, 24 ) + (v5 >> 29);
		intDataPutIntoByteArray(v3, t, 24);
		v12 = a1;
		if (v5 >= 64 - v10) {
			v14 = v3; // v14 = v3+v10; // v
			v15 = 0;
	...
	private static char[] sub_4F1B0(char[] result, int a2, char[] a3) {
		...
		v593 = bytesToIn(v592, 4);  //858796848=33303330
		...
		v8 = bytesToIn(result, 8 );  //BDB8C832
		v9 = bytesToIn(result, 12 );
		v10 = bytesToIn(result, 4 );

		v12 = __ROR4__(v10, 2);
		v11 = v12;
		v13 = v12 ^ v8;
		int temp_result = bytesToIn(result, 0);
		v15 = __ROR4__(temp_result, 2);
		v14 = v15;
		v16 = __ROR4__(temp_result, 27);
		v17 = bytesToIn(v592, 0) + 1518500249 + bytesToIn(result, 16)
				+ v16 + ((v9 ^ v8) & v10 ^ v9);
		v19 = __ROR4__(v17, 27);
		v18 = v593 + 1518500249 + v9
				+ (v13 & bytesToIn(result, 0) ^ v8) + v19;
		v21 = __ROR4__(v17, 2);
		v20 = v21;
		...
		v592 = null;
		v587 = bytesToIn(result, 0) - 899497514 + v580 + v561 + v579
				+ v584;
		v588 = bytesToIn(result, 4) + v577;
		v589 = bytesToIn(result, 8) + v582;
		v590 = bytesToIn(result, 12) + v575;
		intDataPutIntoByteArray(result, bytesToIn(result, 16) + v567,
				16);
		intDataPutIntoByteArray(result, v587, 0 );
		intDataPutIntoByteArray(result, v588, 4 );
		intDataPutIntoByteArray(result, v589, 8);
		intDataPutIntoByteArray(result, v590, 12);
		return result;
	}
